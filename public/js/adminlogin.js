  ...
  axios
    ...
    .then((res) => {
      ...
      if (response.data == "notexist") {
        ...
        window.location.href = "/adminlogin";
        alert(
          "Due to multiple wrong otps, your account has been blocked,contact admin",
        );
      }
    })
    .catch((err) => {
  ...
  axios
    ...
    .then((res) => {
      ...
      if (response.data == "success") {
        ...
        alert(
          "For security reasons your account has been blocked, contact admin",
        );
      } else {
...
function login(event) {
  ...
  axios
    .post("/api/loginaccount", obj)
    .then((res) => {
      const response = res.data;
      console.log(response);
      if (response.data == "notactive") {
        alert(
          "For security reason your account has been blocked,contact admin",
        );
        ...
        alert(
          "For security purpose we have blocked your account,contact admin",
        );
      } else {
